...
- (void)activator:(LAActivator *)activator receiveEvent:(LAEvent *)event {
  ...
  [alert addAction:[UIAlertAction actionWithTitle:LOCALIZE(@"FORCE_FOREGROUND", @"Localizable") style:UIAlertActionStyleDefault handler:^(UIAlertAction *action) {
  ...
  [alert addAction:[UIAlertAction actionWithTitle:LOCALIZE(@"NATIVE", @"Localizable") style:UIAlertActionStyleDefault handler:^(UIAlertAction *action) {
  ...
  [alert addAction:[UIAlertAction actionWithTitle:LOCALIZE(@"SUSPEND_IMMEDIATELY", @"Localizable") style:UIAlertActionStyleDefault handler:^(UIAlertAction *action) {
  ...
  [alert addAction:[UIAlertAction actionWithTitle:LOCALIZE(@"DISABLE", @"Localizable") style:UIAlertActionStyleDefault handler:^(UIAlertAction *action) {
